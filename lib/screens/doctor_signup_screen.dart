        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Doctor Registration', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              const Text('Register as a verified doctor to access the platform'),
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildField(controller: _specializationController, hint: 'Specialization', icon: Icons.local_hospital, validator: (v) => _validateNotEmpty(v, 'Specialization')),
                      _buildField(controller: _pmdcController, hint: 'PMDC Number', icon: Icons.badge, validator: (v) => _validateNotEmpty(v, 'PMDC number')),
